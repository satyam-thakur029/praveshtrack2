...
export default function ProfileScreen() {
  ...
  const [name, setName] = useState('Satyam Thakur');
  const [email, setEmail] = useState('thakursatyam029@gmail.com');
  const [username] = useState('@satyam');
  const [profilePicture, setProfilePicture] = useState('https://api.multiavatar.com/Starcrasher.png');
  const [isEditing, setIsEditing] = useState(false); // Controls the modal visibility

  const handleSave = () => {
    // Generate a new profile picture URL based on the name
    const newProfilePicture = `https://api.multiavatar.com/${encodeURIComponent(name)}.png`;
    
    setProfilePicture(newProfilePicture); // Update the profile picture
      ...
      <View style={styles.settingsSection}>
        ...
        <View style={styles.option}>
          ...
          <View style={styles.optionTextContainer}>
            ...
            <Text style={styles.optionSubtext}>Contact us if you need any help</Text>
          </View>
        </View>
        </TouchableOpacity>
        ...
        <View style={styles.option}>
          ...
          <View style={styles.optionTextContainer}>
            ...
            <Text style={styles.optionSubtext}>Manage the alerts you receive</Text>
          </View>
        </View>
        </TouchableOpacity>
